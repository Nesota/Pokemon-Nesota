...
GoldenrodCity_MapEvents:
	...
	object_event 12, 22, SPRITE_POKEFAN_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodMoveTutor, EVENT_GOLDENROD_CITY_MOVE_TUTOR
