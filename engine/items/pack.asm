; Pack.Jumptable and BattlePack.Jumptable indexes
	...
	const PACKSTATE_INITFIELDPOCKET
	const PACKSTATE_FIELDPOCKETMENU
...
.KeyItemsPocketMenu:
	...
	ld c, PACKSTATE_INITFIELDPOCKET ; right
	call Pack_InterpretJoypad
	ret c
	call .ItemBallsKey_LoadSubmenu
	ret
...
.TMHMPocketMenu:
	farcall TMHMPocket
	ld b, PACKSTATE_INITFIELDPOCKET ; left
...
.FieldPocketMenu:
	ld hl, FieldPocketMenuHeader
	call CopyMenuHeader
	ld a, [wFieldPocketCursor]
	ld [wMenuCursorBuffer], a
	ld a, [wFieldPocketScrollPosition]
	ld [wMenuScrollPosition], a
	call ScrollingMenu
	ld a, [wMenuScrollPosition]
	ld [wFieldPocketScrollPosition], a
	ld a, [wMenuCursorY]
	ld [wFieldPocketCursor], a
...
.FieldPocket:
	ld a, FIELD_POCKET
	call InitPocket
	ld hl, PC_Mart_FieldPocketMenuHeader
	call CopyMenuHeader
	ld a, [wFieldPocketCursor]
	ld [wMenuCursorBuffer], a
	ld a, [wFieldPocketScrollPosition]
...
PackGFXPointers:
	...
	dw PackGFX + (15 tiles) * 5 ; FIELD_POCKET
