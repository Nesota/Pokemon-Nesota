...
VulpixEvosAttacks:
	...
	db 12, CONFUSE_RAY
	db 15, FIRE_SPIN
	db 18, BEAT_UP ;PAYBACK
	db 20, KINESIS ;WILL-O-WISP
	db 23, FAINT_ATTACK ;FEINT Attack
	db 26, LICK ;HEX
	db 28, FLAME_WHEEL
	db 31, PSYWAVE ;Extrasensory
	db 34, SAFEGUARD
	db 36, FLAMETHROWER
	db 39, AMNESIA ;IMPRISON
	db 42, FIRE_BLAST
	db 44, NIGHT_SHADE
