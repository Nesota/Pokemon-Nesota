...
YoungsterGroup:
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG 
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, QUAGSIRE,   TAIL_WHIP, SLAM, CALM_MIND, EARTHQUAKE
	db -1 ; end
...
LassGroup:
	...
	db 18, PSYDUCK,     TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end
	...
	db 21, PSYDUCK,     TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 31, QUAGSIRE,   WATER_GUN, SLAM, CALM_MIND, EARTHQUAKE
...
BugCatcherGroup:
	...
	db 24, BUTTERFREE, CONFUSION, POISONPOWDER, SUPERSONIC
	db 24, BUTTERFREE, CONFUSION, STUN_SPORE, SUPERSONIC
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 24, BUTTERFREE, CONFUSION, SLEEP_POWDER, SUPERSONIC
	db -1 ; end
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,     TAIL_WHIP, DISABLE, CONFUSION
