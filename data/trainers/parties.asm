...
FalknerGroup:
	...
	db  7, PIDGEY, TACKLE, SAND_ATTACK, MUD_SLAP, NO_MOVE
	db  9, PIDGEOTTO, TACKLE, SAND_ATTACK, MUD_SLAP, GUST
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, CLEFAIRY,   DOUBLESLAP, PLAY_ROUGH, ENCORE, METRONOME
...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, CURSE, NIGHT_SHADE, SHADOW_BALL
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER,    SPITE, MEAN_LOOK, NIGHT_SHADE, SHADOW_BALL
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SONICBOOM, THUNDER_WAVE, SCARY_FACE
	db 30, MAGNEMITE,  THUNDERBOLT,   SONICBOOM, THUNDER_WAVE, SCARY_FACE
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, RAGE, KARATE_CHOP, NIGHT_SLASH
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, DRAGONBREATH, DRAGON_CLAW
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, DRAGONBREATH, DRAGON_CLAW
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, DRAGONBREATH, DRAGON_CLAW
	db 40, KINGDRA,    SURF, HYPER_BEAM, DRAGONBREATH, AGILITY
	db -1 ; end
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SONICBOOM, LIGHT_SCREEN
	db 20, ZUBAT,      LEECH_LIFE, BITE, CONFUSE_RAY, ABSORB
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SONICBOOM, LIGHT_SCREEN
	db 20, ZUBAT,      LEECH_LIFE, BITE, CONFUSE_RAY, ABSORB
	db 22, QUILAVA,    LEER, EMBER, QUICK_ATTACK, MUD_SLAP
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, QUILAVA,    EMBER, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, TYPHLOSION,   EMBER, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
...
WillGroup:
	...
	db 41, SLOWBRO,    CURSE, CALM_MIND, BODY_SLAM, PSYCHIC_M
...
BrunoGroup:
	...
	db 42, HITMONTOP,   QUICK_ATTACK, DIG, PROTECT, TRIPLE_KICK
	db 42, HITMONLEE,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 42, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 43, ONIX,       EARTHQUAKE, SANDSTORM, ROCK_SLIDE, BODY_SLAM
	db 46, MACHAMP,    ROCK_SLIDE, FORESIGHT, SPIRIT_BREAK, CROSS_CHOP
	db -1 ; end
...
KarenGroup:
	...
	db 44, MURKROW,    QUICK_ATTACK, FAINT_ATTACK, MEAN_LOOK, WING_ATTACK
	db 47, HOUNDOOM,   NIGHT_SLASH, FLAMETHROWER, FAINT_ATTACK, BULK_UP
	db -1 ; end
...
KogaGroup:
	...
	db 41, VENOMOTH,     GUST, PSYCHIC_M, TOXIC, CONFUSE_RAY
	db 43, FORRETRESS, PROTECT, SWIFT, EXPLOSION, SPIKES
	db 42, MUK,        MINIMIZE, FAINT_ATTACK, TOXIC, GUNK_SHOT
...
BrockGroup:
	...
	db 41, RHYHORN,    FURY_ATTACK, MEGAHORN, EARTHQUAKE, STOMP
	db 42, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, ONIX,       ROCK_SLIDE, SANDSTORM, MAGNITUDE, IRON_TAIL
...
MistyGroup:
	...
	db 42, QUAGSIRE,   SURF, CALM_MIND, EARTHQUAKE, RAIN_DANCE
...
ErikaGroup:
	...
	db 42, TANGELA,    VINE_WHIP, GIGA_DRAIN, SLEEP_POWDER, BODY_SLAM
	db 41, JUMPLUFF,   MEGA_DRAIN, LEECH_SEED, GIGA_DRAIN, MEAN_LOOK
...
YoungsterGroup:
	...
	db 21, RATICATE, QUICK_ATTACK, HYPER_FANG, SCARY_FACE, NIGHT_SLASH
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE, QUICK_ATTACK, HYPER_FANG, NIGHT_SLASH, THIEF
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, RATICATE,   HYPER_BEAM, QUICK_ATTACK, SUPER_FANG, CRUNCH
	db -1 ; end
...
SchoolboyGroup:
	...
	db 32, TANGELA,    POISONPOWDER, VINE_WHIP, MEGA_DRAIN, PURSUIT
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, SONICBOOM, PURSUIT
	db 35, QUAGSIRE,   CALM_MIND, MAGNITUDE, SPORE, BODY_SLAM
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    TOXIC, QUICK_ATTACK, WING_ATTACK, AGILITY
	db 38, PIDGEOT,    SWIFT, PROTECT, STEEL_WING, WING_ATTACK
	db -1 ; end
...
LassGroup:
	...
	db 18, PSYDUCK,    DISABLE, CONFUSION, BUBBLEBEAM, FURY_ATTACK
	db -1 ; end
	...
	db 21, PSYDUCK,    DISABLE, CONFUSION, BUBBLEBEAM, FURY_ATTACK
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 29, PSYDUCK,     DISABLE, WATERFALL, SCREECH, ZEN_HEADBUTT
	db 29, AMPHAROS,   TAKE_DOWN, SPARK, THUNDER_WAVE, CONFUSE_RAY
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,     DISABLE, ZEN_HEADBUTT, SCREECH, WATERFALL
	db 32, AMPHAROS,   TACKLE, THUNDERPUNCH, THUNDER_WAVE, CONFUSE_RAY
	db -1 ; end

	; LASS (17)
	db "DANA@", TRAINERTYPE_MOVES
	db 36, AMPHAROS,   SWIFT, THUNDERPUNCH, THUNDER_WAVE, CONFUSE_RAY
...
JanineGroup:
	...
	db 36, CROBAT,     MEAN_LOOK, CONFUSE_RAY, WING_ATTACK, SLUDGE
	db 36, WEEZING,    SLUDGE_BOMB, TOXIC, EXPLOSION, IRON_HEAD
	db 36, WEEZING,    SLUDGE_BOMB, TOXIC, EXPLOSION, IRON_HEAD
...
CooltrainerMGroup:
	...
	db 26, CHARMANDER, FIRE_FANG, DRAGON_RAGE, SCARY_FACE, SAND_ATTACK
	db 26, SQUIRTLE,   WATER_PULSE, BITE, RAPID_SPIN, PROTECT
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP,  PROTECT, METAL_CLAW
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP,  BLIZZARD, METAL_CLAW
	db 39, FLAREON,    NO_ITEM,      FLAMETHROWER, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (8)
	db "RYAN@", TRAINERTYPE_MOVES
	db 25, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WING_ATTACK, TOXIC
	...
	db 35, GOLDUCK,    ZEN_HEADBUTT, SCREECH, PSYCH_UP, WATERFALL
	db -1 ; end

	; COOLTRAINERM (10)
	db "GAVEN@", TRAINERTYPE_MOVES
	db 32, VICTREEBEL, WRAP, TOXIC, ACID, RAZOR_LEAF
	db 32, KINGLER,    BUBBLEBEAM, STOMP,  PROTECT, METAL_CLAW
	db 32, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end

	; COOLTRAINERM (11)
	db "BLAKE@", TRAINERTYPE_MOVES
	db 33, MAGNETON,   THUNDERBOLT, SWIFT, SCREECH, FLASH_CANNON
	db 31, QUAGSIRE,   WATER_GUN, CALM_MIND, EARTHQUAKE, BODY_SLAM
	...
	db 27, CHARMELEON, FIRE_FANG, DRAGON_RAGE, SCARY_FACE, SAND_ATTACK
	db -1 ; end

	; COOLTRAINERM (20)
	db "DARIN@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_RAGE, AGILITY
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, BUTTERFREE, CONFUSION, SLEEP_POWDER, GUST, SIGNAL_BEAM
	...
	db 33, HORSEA,       LEER, WHIRLPOOL, TWISTER, SCALD
	db 33, HORSEA,       LEER, WHIRLPOOL, TWISTER, SCALD
...
BeautyGroup:
	...
	db 16, MEOWTH,      GROWL, BITE, PAY_DAY, FURY_ATTACK
	db 16, MEOWTH,      GROWL, BITE, SLASH, QUICK_ATTACK
	db -1 ; end
	...
	db 17, HOPPIP,     SYNTHESIS, TACKLE, POISONPOWDER, VINE_WHIP
	db 17, SKIPLOOM,   SYNTHESIS, TACKLE, STUN_SPORE, VINE_WHIP
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, LICKITUNG, TACKLE,LICK,CONFUSE_RAY,NO_MOVE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 28, VENOMOTH,   DISABLE,   CONFUSION, LEECH_LIFE, NO_MOVE
	db -1 ; end

	; BUG_CATCHER (15)
	db "WADE@", TRAINERTYPE_MOVES
	db 24, BUTTERFREE, CONFUSION, POISONPOWDER, GUST, HARDEN
	db 24, BUTTERFREE, CONFUSION, STUN_SPORE, GUST, HARDEN
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 24, BUTTERFREE, CONFUSION, SLEEP_POWDER, GUST, HARDEN
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, BUTTERFREE, CONFUSION, POISONPOWDER,   GUST, HARDEN
	db 30, BUTTERFREE, CONFUSION, STUN_SPORE,   GUST, HARDEN
	db 32, BEEDRILL,   FURY_ATTACK,  TWINEEDLE, DOUBLE_TEAM, TACKLE
	db 34, BUTTERFREE, PSYBEAM, SLEEP_POWDER, GUST, HARDEN
	db -1 ; end

	; BUG_CATCHER (17)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 36, VENOMOTH,   GUST,   PSYBEAM, LEECH_LIFE, NO_MOVE
	db -1 ; end

	; BUG_CATCHER (18)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 40, VENOMOTH,   GUST,   PSYCHIC_M, TOXIC, NO_MOVE
	db -1 ; end
...
FisherGroup:
	...
	db 34, SEAKING,      WATERFALL, FLAIL, FURY_ATTACK, AGILITY
	db 34, SEAKING,      WATERFALL, FLAIL, FURY_ATTACK, AGILITY
	...
	db 34, SEAKING,      RAIN_DANCE, WATERFALL, FURY_ATTACK, AGILITY
	db 34, SEAKING,      RAIN_DANCE, WATERFALL, FURY_ATTACK, AGILITY
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    DISABLE, CONFUSION, WATER_GUN, TACKLE
	db 22, GOLDEEN,    PECK,   HORN_ATTACK, RECOVER, WATER_PULSE
	db -1 ; end
	...
	db 21, HORSEA,       LEER, WATER_PULSE, BUBBLEBEAM, TWISTER
	db 21, HORSEA,     DRAGON_RAGE,   LEER, WATER_GUN, WATER_PULSE
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     LEER,  HARDEN, BUBBLEBEAM, CUT
	db 20, KRABBY,     BUBBLEBEAM, LEER,  HARDEN, MUD_SLAP
	db -1 ; end
...
SuperNerdGroup:
	...
	db 39, SEADRA,       TWISTER, SURF, WATERFALL, WATER_PULSE
	db -1 ; end
...
Rival2Group:
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, TYPHLOSION,   QUICK_ATTACK, FLAME_WHEEL, SWIFT, EARTHQUAKE
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, TYPHLOSION,   QUICK_ATTACK, FIRE_BLAST, SWIFT, EARTHQUAKE
	db -1 ; end
...
HikerGroup:
	...
	db 38, STEELIX,    DIG, IRON_TAIL, SANDSTORM, ROCK_SLIDE
	db -1 ; end
...
BlaineGroup:
	...
	db 45, MAGCARGO,   CURSE, FLAMETHROWER, ROCK_SLIDE, BODY_SLAM
...
BurglarGroup:
	...
	db 24, KOFFING,    TACKLE, SLUDGE, SELFDESTRUCT, SPORE
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, HI_JUMP_KICK, FOCUS_ENERGY, FEINT
	db -1 ; end

	; BLACKBELT_T (3)
	db "KENJI@", TRAINERTYPE_MOVES
	db 33, ONIX,       ROCK_THROW, TOXIC, DIG, BODY_SLAM
...
ExecutiveMGroup:
	...
	db 33, KOFFING,    TACKLE, SLUDGE, HAZE, SELFDESTRUCT
	db 35, HOUNDOOM,   EMBER, BITE, FAINT_ATTACK, THUNDER_FANG
	db -1 ; end
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, IRON_HEAD
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, IRON_HEAD
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, IRON_HEAD
	db 32, WEEZING,    TACKLE, EXPLOSION, SLUDGE, IRON_HEAD
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, IRON_HEAD
	db 30, KOFFING,    TACKLE, SLUDGE, SELFDESTRUCT, IRON_HEAD
	db -1 ; end
...
PsychicGroup:
	...
	db 17, DROWZEE,    HYPNOSIS, DISABLE, DREAM_EATER, HEADBUTT
	db -1 ; end
...
PicnickerGroup:
	...
	db 32, NIDOQUEEN,  EARTHQUAKE, DOUBLE_KICK, BODY_SLAM, BITE
	db -1 ; end
	...
	db 33, JUMPLUFF,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, MEGA_DRAIN
	db 33, JUMPLUFF,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, MEGA_DRAIN
...
CamperGroup:
	...
	db 33, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
	db 36, MAGCARGO,   ROCK_THROW, HARDEN, CALM_MIND, FLAMETHROWER
...
ExecutiveFGroup:
	...
	db 32, MURKROW,    PECK,  HAZE, NIGHT_SHADE, NIGHT_SLASH
	db -1 ; end
	...
	db 25, MURKROW,    PECK,  HAZE, NIGHT_SHADE, NIGHT_SLASH
	db -1 ; end
...
RedGroup:
	...
	db 75, SNORLAX,    CALM_MIND, SNORE, REST, BODY_SLAM
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, WING_ATTACK, EXTREMESPEED, AGILITY
