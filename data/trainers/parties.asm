...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER,    SPITE, MEAN_LOOK, NIGHT_SHADE
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SONICBOOM, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT,   SONICBOOM, THUNDER_WAVE
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, RAGE, KARATE_CHOP
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, DRAGONBREATH
	db 40, KINGDRA,    SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK,   SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE,   BITE, CONFUSE_RAY
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK,   SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE,   BITE, CONFUSE_RAY
	db 22, QUILAVA,    LEER, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, QUILAVA,    EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, TYPHLOSION,   EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
...
KarenGroup:
	...
	db 44, MURKROW,    QUICK_ATTACK,  FAINT_ATTACK
	db 47, HOUNDOOM,   ROAR,  FLAMETHROWER, CRUNCH
	db -1 ; end
...
KogaGroup:
	...
	db 41, VENOMOTH,     GUST, PSYCHIC_M, TOXIC
	db 43, FORRETRESS, PROTECT, SWIFT, EXPLOSION, SPIKES
	db 42, MUK,        MINIMIZE, SLUDGE_BOMB, TOXIC
...
BrockGroup:
	...
	db 44, ONIX,       ROCK_SLIDE, SANDSTORM
...
ErikaGroup:
	...
	db 42, TANGELA,    VINE_WHIP, GIGA_DRAIN, SLEEP_POWDER
	db 41, JUMPLUFF,   MEGA_DRAIN, LEECH_SEED, GIGA_DRAIN
...
YoungsterGroup:
	...
	db 21, RATICATE, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE, QUICK_ATTACK, HYPER_FANG 
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, RATICATE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG
	db -1 ; end
...
SchoolboyGroup:
	...
	db 32, TANGELA,    POISONPOWDER, VINE_WHIP, MEGA_DRAIN
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, SONICBOOM
	db 35, QUAGSIRE,   CALM_MIND, EARTHQUAKE
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    TOXIC, QUICK_ATTACK, FLY
...
LassGroup:
	...
	db 18, PSYDUCK,    DISABLE, CONFUSION
	db -1 ; end
	...
	db 21, PSYDUCK,    DISABLE, CONFUSION
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 29, PSYDUCK,     DISABLE, CONFUSION, SCREECH
	db 29, AMPHAROS,   TACKLE, THUNDERSHOCK, THUNDER_WAVE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,     DISABLE, CONFUSION, SCREECH
	db 32, AMPHAROS,   TACKLE, THUNDERPUNCH, THUNDER_WAVE
	db -1 ; end

	; LASS (17)
	db "DANA@", TRAINERTYPE_MOVES
	db 36, AMPHAROS,   SWIFT, THUNDERPUNCH, THUNDER_WAVE
...
JanineGroup:
	...
	db 36, CROBAT,     SCREECH,   CONFUSE_RAY, WING_ATTACK
	db 36, WEEZING,    SLUDGE_BOMB, TOXIC, EXPLOSION
	db 36, WEEZING,    SLUDGE_BOMB, TOXIC, EXPLOSION
...
CooltrainerMGroup:
	...
	db 26, CHARMANDER, EMBER,   RAGE, SCARY_FACE
	db 26, SQUIRTLE,   WATER_GUN, BITE, CURSE
	...
	db 25, PIDGEOT,    SAND_ATTACK, QUICK_ATTACK, WING_ATTACK
	...
	db 35, GOLDUCK,    CONFUSION, SCREECH, PSYCH_UP
	db -1 ; end
	...
	db 33, MAGNETON,   THUNDERBOLT,   SWIFT, SCREECH
	db 31, QUAGSIRE,   WATER_GUN, CALM_MIND, EARTHQUAKE
	...
	db 27, CHARMELEON, EMBER,   RAGE, SCARY_FACE
	db -1 ; end

	; COOLTRAINERM (20)
	db "DARIN@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_RAGE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, BUTTERFREE, CONFUSION, SLEEP_POWDER, GUST
	...
	db 33, HORSEA,       LEER, WHIRLPOOL, TWISTER
	db 33, HORSEA,       LEER, WHIRLPOOL, TWISTER
...
BeautyGroup:
	...
	db 16, MEOWTH,      GROWL, BITE, PAY_DAY
	db 16, MEOWTH,      GROWL, BITE, SLASH
	db -1 ; end
	...
	db 17, HOPPIP,     SYNTHESIS, TACKLE, POISONPOWDER
	db 17, SKIPLOOM,   SYNTHESIS, TACKLE, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, LICKITUNG,  LICK,   CUT, NO_MOVE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 28, VENOMOTH,   DISABLE,   CONFUSION, LEECH_LIFE
	db -1 ; end

	; BUG_CATCHER (15)
	db "WADE@", TRAINERTYPE_MOVES
	db 24, BUTTERFREE, CONFUSION, POISONPOWDER
	db 24, BUTTERFREE, CONFUSION, STUN_SPORE
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 24, BUTTERFREE, CONFUSION, SLEEP_POWDER
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, BUTTERFREE, CONFUSION, POISONPOWDER,   GUST
	db 30, BUTTERFREE, CONFUSION, STUN_SPORE,   GUST
	db 32, BEEDRILL,   FURY_ATTACK,  TWINEEDLE, DOUBLE_TEAM
	db 34, BUTTERFREE, PSYBEAM, SLEEP_POWDER, GUST
	db -1 ; end

	; BUG_CATCHER (17)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 36, VENOMOTH,   GUST,   PSYBEAM, LEECH_LIFE
	db -1 ; end

	; BUG_CATCHER (18)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 40, VENOMOTH,   GUST,   PSYCHIC_M, TOXIC
	db -1 ; end
...
FisherGroup:
	...
	db 34, SEAKING,      WATERFALL, FLAIL, FURY_ATTACK
	db 34, SEAKING,      WATERFALL, FLAIL, FURY_ATTACK
	...
	db 34, SEAKING,      RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 34, SEAKING,      RAIN_DANCE, WATERFALL, FURY_ATTACK
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    DISABLE, CONFUSION
	db 22, GOLDEEN,    PECK,   HORN_ATTACK
	db -1 ; end
	...
	db 21, HORSEA,       LEER, WATER_GUN
	db 21, HORSEA,     DRAGON_RAGE,   LEER, WATER_GUN
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     LEER,  HARDEN
	db 20, KRABBY,     BUBBLEBEAM, LEER,  HARDEN
	db -1 ; end
...
SuperNerdGroup:
	...
	db 39, SEADRA,       TWISTER, SURF, WATERFALL
	db -1 ; end
...
Rival2Group:
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, TYPHLOSION,   QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, TYPHLOSION,   QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
...
HikerGroup:
	...
	db 38, STEELIX,    DIG, IRON_TAIL, SANDSTORM
	db -1 ; end
...
BlaineGroup:
	...
	db 45, MAGCARGO,   CURSE, FLAMETHROWER, ROCK_SLIDE
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, HI_JUMP_KICK, FOCUS_ENERGY
	db -1 ; end

	; BLACKBELT_T (3)
	db "KENJI@", TRAINERTYPE_MOVES
	db 33, ONIX,       ROCK_THROW, TOXIC, DIG
...
ExecutiveMGroup:
	...
	db 33, KOFFING,    TACKLE, SLUDGE,   HAZE
	db 35, HOUNDOOM,   EMBER, BITE, FAINT_ATTACK
	db -1 ; end
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE
	db 32, WEEZING,    TACKLE, EXPLOSION, SLUDGE
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE
	db 30, KOFFING,    TACKLE, SLUDGE
	db -1 ; end
...
PicnickerGroup:
	...
	db 32, NIDOQUEEN,  EARTHQUAKE, DOUBLE_KICK, BODY_SLAM
	db -1 ; end
	...
	db 33, JUMPLUFF,   STUN_SPORE, SUNNY_DAY, LEECH_SEED
	db 33, JUMPLUFF,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED
...
ExecutiveFGroup:
	...
	db 32, MURKROW,    PECK,  HAZE, NIGHT_SHADE
	db -1 ; end
	...
	db 25, MURKROW,    PECK,  HAZE, NO_MOVE
	db -1 ; end
...
BlueGroup:
	...
	db 56, PIDGEOT,    QUICK_ATTACK, WING_ATTACK
