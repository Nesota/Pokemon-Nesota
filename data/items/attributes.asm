...
; WATER_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HATCHET
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, FIELD, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; HP_UP
...
; FOCUS GLASS
	item_attribute 2500, HELD_PREVENT_CONFUSE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; UP_GRADE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; BERRY
