...
MapGroup_NewBarkPark:
	map NewBarkPark, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map FloralPath, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_FLORAL
	map MysticCave, TILESET_CAVE, CAVE, LANDMARK_NEW_BARK_TOWN, MUSIC_DARK_CAVE, FALSE, PALETTE_DARK, FISHGROUP_FLORAL
