...
; MoveTutor setval arguments
	...
	const MOVETUTOR_HEX ; 1
	const MOVETUTOR_GUNK_SHOT  ; 2
	const MOVETUTOR_WATER_PULSE    ; 3
	const MOVETUTOR_DAZZLE_GLEAM ; 1
	const MOVETUTOR_DARK_PULSE  ; 2
	const MOVETUTOR_AVALANCHE    ; 3
	const MOVETUTOR_IRON_HEAD ; 1
	const MOVETUTOR_AERIAL_ACE  ; 2
	const MOVETUTOR_ENERGY_BALL    ; 3
	const MOVETUTOR_ZEN_HEADBUTT ; 1
	const MOVETUTOR_BULK_UP  ; 2
	const MOVETUTOR_CALM_MIND    ; 3
	const MOVETUTOR_DRAGON_DANCE    ; 3
	const MOVETUTOR_SWORDS_DANCE ; 1
	const MOVETUTOR_NASTY_PLOT  ; 2
	const MOVETUTOR_HONE_CLAWS    ; 3
